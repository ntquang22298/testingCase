...
describe('Kiem tra chuc nang giao bai tap', function () {
    context('Test HL_GBT_48', function () {
        it('Đăng nhập tài khoản giáo viên', function() {
            const _username = 'ntquang22298@gmail.com'
            const _password = 'tanhoi98'
        ...
        it('Ngày giờ bắt đầu tăng 5s so với giá trị cũ sau khi nhập sai và nhấn up arrow key', function () {
        ...
        it('Ngày giờ bắt đầu giảm 5s so với giá trị cũ sau khi nhập sai và nhấn down arrow key', function() {
            var a = cy.get('[placeholder="MM"]').first()
            a.invoke('val').then((val1) => {
                cy.log('before: ' + val1)
                var b = cy.get('[placeholder="MM"]').first()
        ...
        it('Ngày giờ kết thúc tăng 5s so với giá trị cũ sau khi nhập sai và nhấn up arrow key', function () {
        ...
        it('Ngày giờ kết thúc giảm 5s so với giá trị cũ sau khi nhập sai và nhấn down arrow key', function() {
            var a = cy.get('[placeholder="MM"]').last()
            a.invoke('val').then((val1) => {
                cy.log('before: ' + val1)
                var b = cy.get('[placeholder="MM"]').last()
